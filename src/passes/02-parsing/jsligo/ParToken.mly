...
%token             <string Wrap.wrap> BlockCom  "<block_comment>" [@recover.expr Token.ghost_block_com]
%token             <string Wrap.wrap> LineCom   "<line_comment>"  [@recover.expr Token.ghost_line_com]
